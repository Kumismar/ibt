...
const std::vector<Rule> Grammar2::rightSideRules = {
    { new Token(tIf), new Token(tLPar), new Nonterminal(nExpression), new Token(tRPar), new Nonterminal(nCodeBlock), new Nonterminal(nStop), new Nonterminal(nIf2), new Nonterminal(nStop) },
    ...
    { new Nonterminal(nCodeBlock), new Nonterminal(nStop) },
    { new Token(tReturn), new Nonterminal(nReturnExp), new Token(tSemi) },
    { new Token(tSemi) },
    { new Token(tElseif), new Token(tLPar), new Nonterminal(nExpression), new Token(tRPar), new Nonterminal(nCodeBlock), new Nonterminal(nStop), new Nonterminal(nIf2), new Nonterminal(nStop) },

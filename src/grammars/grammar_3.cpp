 ...
 * @ Modified time: 2024-04-07 20:39
 */
...
const std::vector<Rule> Grammar3::rightSideRules = {
    { new Token(tFunction), new Token(tFuncName), new Token(tLPar), new Nonterminal(nParams), new Token(tRPar), new Token(tColon), new Nonterminal(nVoluntaryType), new Token(tLCurl), new Nonterminal(nStatements), new Nonterminal(nStop), new Token(tRCurl) },

...
\todo{odkaz na definici jazyka pcgs}
...
\todo{pridat matematickou formulaci z \cite{PCGS-chapter2}}
...
\todo{prima derivace, jazyk generovany pcgs (z prezentaci), centralizovane, vracejici/nevracejici, notace jazyku}

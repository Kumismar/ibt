...
\dotaz{samotne komponenty patri do prilohy nebo je mam nechat tady?}
...
\dotaz{Tato část mi přijde hodně hodně stručná -- rád bych k ní napsal něco víc, ale nevím, co by sem ještě mohlo patřit.
Budu ještě potřebovat pomoci s~formalizací této části.}
...
Důvod je zvolený postup prediktivní analýzy volání funkcí\,--\,o~samotné výrazy bez volání funkcí, tedy pouze výrazy s~konstantami, proměnnými a~podobně, se postará analýza precedenční.
...
Prediktivní analýza spoléhá na dvě polymorfní metody, které jsou přepsány v~uzlech, které dědí od třídy \texttt{Statement}.

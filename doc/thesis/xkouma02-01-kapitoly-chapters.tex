...
Programovací jazyky jsou kompromisem mezi přirozenými a~strojovými jazyky.
Jsou navrhnuty tak, aby jim rozuměl člověk a~zároveň bylo jednoduché je přeložit do jazyka, kterému rozumí počítače.

Jednu z~klíčových rolí při překladu sehrává syntaktická analýza.
To je proces, který ověřuje správnost jednotlivých konstrukcí programovacího jazyka a~jejich pořadí.

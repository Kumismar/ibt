...
Zkrátka vloží na zásobník \texttt{t\textunderscore FuncEnd} tam, kde je volání funkce ukončeno pravou závorkou \texttt{)}.
...
První zásobník je společný pro oba analyzátory, přičemž precedenční pouze vyjme neterminál \texttt{nt\textunderscore Expression}, pokud analýza skončí úspěšně.
...
Analýza výrazů začíná vložením pomocného terminálu \texttt{t\textunderscore ExpEnd} na společný zásobník, což je implementováno pomocí procházení společného zásobníku a~přeskakování operátorů a~operandů.

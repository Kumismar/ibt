...
Derivačních režimů existuje mnohem více\dotaz{Zdroj??}, nejsou ale pro tuto práci podstatné.
...
\begin{definition}\label{def_mozne_derivace}
    ...
    Potom 
    \begin{equation*}
        F(G_j,\beta,f)=\{\beta : \alpha_j\Rightarrow^{f}\beta\},\; j \in \{1, \ldots, n\},\; f\in D,\; u\in (N \cup T)^{*}
    \end{equation*}        

...
Překladač je implementován v~jazyce C++ ve standardu C++20, je naprogramován pro UNIXové operační systémy jako konzolová aplikace. \todo{pak dopsat kde vsude je to vyzkouseny a s jakyma prekladacama}
...
Pro každý soubor v~těchto podsložkách je korespondující \emph{.rc} (\emph{return code}) soubor.
